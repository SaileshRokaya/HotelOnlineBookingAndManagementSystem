...
//		   Full screen
		...
		JLabel lblRestaurantAndBar = new JLabel("Res/Bar Services");
...
//				String vat3 = Double.toString(vat2);
		...
		comServiceType.setModel(new DefaultComboBoxModel(new String[] {"Restaurant Item","Bar Item"}));
		...
		comServiceType.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				item = (String) comServiceType.getSelectedItem();
		...
		try {
    		...
    		while(rst3.next()) {
    			...
    			String query = "select c.Fullname, r.RoomNo, s.ServiceType, s.Quantity, s.Rate, s.Total \r\n"
    					...
    					+ " where s.ServiceType='Restaurant Item' or s.ServiceType='Bar Item'";
